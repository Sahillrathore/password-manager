...
const Banner = () => {
  return (
    <section className='h-fit py-10 mx-12 rounded-3xl bg-[#16379a] mx-auto my-6 flex md:flex-row flex-col-reverse md:items-center items-start md:gap-12 gap-7 justify-between sm:px-16 px-12'> 
